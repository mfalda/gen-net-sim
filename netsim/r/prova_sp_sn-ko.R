...
net<-simulatenet_dll(N, connectivity="MTM", save=TRUE, itera=3)
...
ris <- simulateprofiles_dll(weights=pesi, lambda=lambda, alpha=alpha, beta=beta, method="rkf45", params=params, ko.experim=c(1,3,5), itera=4, times=times)
ris
cat("ok")
