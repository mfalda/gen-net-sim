...
ris <- simulateprofiles(weights=pesi, f.pr.and="1 / (1 + e ^ (-10 * (x - 0.5)))", Rules=rules, lambda=p[,1], alpha=p[,2], beta=p[,3], x0=p[,4], Xmin=p[,5], Xmax=p[,6], params=c(0,0,0,0,0,0), times=seq(0, 5, 0.1), save=TRUE)
