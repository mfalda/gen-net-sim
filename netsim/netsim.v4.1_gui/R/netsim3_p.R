...
glbls_s <- list(
  ...
  list("stat_w", TESTO, "0", num_ctrl_s, "the percentage of consecutive sampling times during which the signal has to satisfy the stationarity hypothesis (zero to disable the stationarity check)"),
  # 66
