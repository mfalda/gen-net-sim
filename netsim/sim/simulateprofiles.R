simulateprofiles<-function(weights, Rules=list(), f.pr.and="", act.fun="sigmoidal",alpha=c(10,0.2), beta=c(0.5,0.01), lambda=c(1,0.1), Xmin=NULL, Xmax=NULL, X0=c(0,1), params=c(2,2,2,0,0,1), ko.experim=NULL, times=seq(0,5,0.05), stat_thr=0.001, stat_width=0, method="rkf45", EXT.IN=NA, EXT.FUN=list(), itera=1, save=FALSE)
{
    if (!is.null(weights)) {
