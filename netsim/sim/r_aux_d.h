...
*/
#ifdef MDEBUG
	#define copia1_m_colonna_d(m1, colonna1, m2, colonna2) _copia1_m_colonna_d(m1, colonna1, m2, colonna2, __FILE__, __LINE__)
#else
	#define copia1_m_colonna_d(m1, colonna1, m2, colonna2) _copia1_m_colonna_d(m1, colonna1, m2, colonna2)
#endif
#ifdef MDEBUG
	void  _copia1_m_colonna_d(MATRICEd *m1, int colonna1, const MATRICEd *m2, int colonna2, const char *nomefile, int linea);
#else
	void  _copia1_m_colonna_d(MATRICEd *m1, int colonna1, const MATRICEd *m2, int colonna2);
#endif
