...
glbls_g <- list(
  ...
  list("stat_w", TESTO, "0", num_ctrl_g, "percentage of the maximum sampling time during which the signal has to satisfy the stationarity hypothesis (zero to disable the stationarity check)"),
  # 66
...
{
  # "primo_g" mi dice se è la prima volta che ci passo, nel qual caso devo prima creare le liste in cui memorizzerò i valori
