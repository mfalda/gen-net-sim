...
// convenzione per i nomi: [_]nome[1]_inp_funz_tipo
...
#endif
#ifdef MDEBUG
#warning "debug della memoria attivato"
#endif
#ifdef FDEBUG
#warning "debug delle funzioni attivato"
#endif

#ifdef __WIN32__
#warning "definisco bool"
...
/*!
	...
	\note possono risultare piu` deallocazioni che allocazioni: capita quando le stringhe non sono copie ma puntatori (tuttavia non e` pericoloso). Usare prima di ControllaCanc, perche� le serve un handle chiuso da quella
*/
void StrBilanciam();
...
/*!
	...
	\param L il nome della lista
	\param T un vettore con il tipo di elementi (NULL per creare una lista di vettori di interi)
	\param len la lunghezza del vettore t

	\return un puntatore alla nuova lista
*/
#ifdef MDEBUG
