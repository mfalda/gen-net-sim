...
# function that check if the networkis connected
...
##OUTPUT
# dist: vector of distances (indirected graph is considered) between node 1 and the other nodes in the networks (some will be Inf if the network is not connected)
