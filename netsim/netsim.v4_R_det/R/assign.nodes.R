...
#M: matrice di adiacenza trasposta (i,j)!=0 significa che i regola j. Contiene numeri reali
#Mdiscr: come M ma contiene 0 o 1 per ogni elemento (i,j)
#
#
#
#
